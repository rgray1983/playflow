              ...
              <div className="h-full overflow-y-auto p-5 pb-24">
                ...
                <section className="mb-4 rounded-[14px] border border-black/10 bg-[#F6F0E6] p-4">
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-3">
                    ...
                    {party.rawStatus !== "CANCELLED" && !completeAvailable && nextStep && <button onClick={() => setGuardrail({ type: "advance", step: currentStep, party })} className="rounded-[10px] bg-[#1E293B] px-5 py-3 text-sm font-semibold text-white">{currentStep?.actionLabel ?? "Next Step"}</button>}
