...
type Party = { id: string; childName: string; title: string; eventNumber: string; eventTypeName: string; date: string; time: string; status: string; rawStatus: string; workflowStep: PartyWorkflowStepKey; packageName: string; room: string; guestCount: number; expectedCount: number; checkedInCount: number; checkedOutCount: number; noShowCount: number; waiverNeededCount: number; deposit: string; depositStatus: string; balanceDue: string; balanceDueNumber: number; notes: string; inviteUrl: string | null; confirmationUrl: string | null; pendingExpiresAt: string | null; incidentCount: number; timelineItems: EventTimelineItem[]; guests: PartyGuest[] };
